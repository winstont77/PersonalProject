...
export default{
    setup(){
        let schedule = ref([]);
        let gotoCloseHistory = ()=>{
            router.push({path:"closeHistory"})
        }
        onMounted(()=>{
            ...
            <div class="sph-LiveInPlayHeader_Scroller">
                <div class="sph-HorizontalLiveNavBarScroller_Wrapper">
                    <div class="sph-HorizontalLiveNavBarScroller_Contents">
                        <div class="sph-LiveInPlayButtonBarButton">所有</div>
                        <div class="sph-LiveInPlayButtonBarButton">未結算</div>
                        <div class="sph-LiveInPlayButtonBarButton" v-on:click="gotoCloseHistory">已結算</div>
                    </div>
                </div>
            </div>
        </div>
